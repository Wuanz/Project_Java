CREATE DATABASE  IF NOT EXISTS `DATAN12`;
USE `DATAN12`;

CREATE TABLE `DATAN12`.`tbl_employees` (
...
CREATE TABLE `DATAN12`.`tbl_product` (
  `id` int(15) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `DATAN12`.`tbl_users` (
...
CREATE TABLE `DATAN12`.`tbl_roles` (
  `role_id` int(15) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`role_id`)
);

CREATE TABLE `DATAN12`.`tbl_users_roles` (
